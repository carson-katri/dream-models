...
class SPAR3D(BaseModule):
    ...
    def generate_mesh(
        ...
        print(batch["rgb_cond"].dtype)
        print("mask_cond")
        print(batch["mask_cond"].shape)
        print(batch["mask_cond"].dtype)
        print("c2w_cond")
        print(batch["c2w_cond"].shape)
        print(batch["c2w_cond"].dtype)
        print("intrinsic_cond")
        print(batch["intrinsic_cond"].shape)
        print(batch["intrinsic_cond"].dtype)
        print("intrinsic_normed_cond")
        print(batch["intrinsic_normed_cond"].shape)
        print(batch["intrinsic_normed_cond"].dtype)
        ...
        if "pc_cond" not in batch:
            ...
            print(denoised_pc.shape)
            print(denoised_pc.dtype)
